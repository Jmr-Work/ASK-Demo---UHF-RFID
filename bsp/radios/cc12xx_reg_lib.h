...
typedef enum {                                                              /*@ref [4] MARCSTATE.MARC_STATE - p.101                 */
    ...
    IDLE           = b00000001,
    XOFF           = b00000010,
    BIAS_SETTLE_MC = b00000011,
    REG_SETTLE_MC  = b00000100,
    MANCAL         = b00000101,
    BIAS_SETTLE    = b00000110,
    REG_SETTLE     = b00000111,
    STARTCAL       = b00001000,
    BWBOOST        = b00001001,
    FS_LOCK        = b00001010,
    IFADCON        = b00001011,
    ...
    RX_END         = b00001110,
    RSVD           = b00001111,
    TXRX_SWITCH    = b00010000,
    RX_FIFO_ERR    = b00010001,
    FSTXON         = b00010010,
    TX             = b00010011,
    TX_END         = b00010100,
    RXTX_SWITCH    = b00010101,
    TX_FIFO_ERR    = b00010110,
    IFADCON_TXRX   = b00010111
} marc_state_t;
